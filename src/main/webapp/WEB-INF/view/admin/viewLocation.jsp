...
<html lang="en">
  ...
  <body class="layout layout-header-fixed layout-left-sidebar-fixed">
          ...
          <div class="panel-body">
            ...
            <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
              <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                <c:forEach items="${locationList}" var="z">
                  <tr>
                    <td>${z.locationId}</td>
                    <td>${z.locationName}</td>
                    <td>${z.locationDescription}</td>
                    <td>
                    <div class="pull-left">
				            <a href="editLocation?id=${z.locationId }" class="btn btn-outline-info">Edit</a>
				     </div>
				     
                    <div>
				            <a href="deleteLocation?id=${z.locationId }" class="btn btn-outline-info">Delete</a>
				     </div>
				     </td>
                    <!-- <td>X</td> -->
                  </tr>
    ...
    <script src="adminResourses/js/tables-datatables.min.js"></script>
  </body>
</html>