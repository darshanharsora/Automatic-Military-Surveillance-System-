          ...
          <div class="panel-body">
            ...
            <div class="row">
              ...
              <%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
                <form:form data-toggle="validator" action="/insertLocation" modelAttribute="locationVO" method="POST">
                  <form:hidden path="locationId"/>
                  
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Location Name</label>
                    <form:input path="locationName" class="form-control" id="form-control-2" placeholder="Location_Name" data-error="This field is required." required=""/>
                    <div class="help-block with-errors"></div>
                  </div>
                  
                 <div class="form-group">
                    <label for="form-control-2" class="control-label">Location Description</label>
                    <form:textarea  path="locationDescription" id="form-control-2" class="form-control" rows="3" data-error="This field is required." required=""></form:textarea>
                    <div class="help-block with-errors">Write some details about location.</div>
                  </div>
