          ...
          <div class="panel-body">
            ...
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" action="/insertDataset" modelAttribute="datasetVO" method="POST">
                  
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Dataset Name</label>
                    <input type="text" class="form-control" id="form-control-2" placeholder="Dataset Name" data-error="This field is required." required>
                    <div class="help-block with-errors"></div>
                  </div>
                  
                   <div class="form-group">
                    <label for="form-control-2" class="control-label">Choose File</label>
