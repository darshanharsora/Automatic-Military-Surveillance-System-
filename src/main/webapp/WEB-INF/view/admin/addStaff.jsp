          ...
          <div class="panel-body">
            ...
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" action="/insertStaff" modelAttribute="staffVO" method="POST">
                  
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Username</label>
                    <input type="text" class="form-control" id="form-control-2" placeholder="Username" data-error="This field is required." required>
                    <div class="help-block with-errors"></div>
                  </div>
                  
                   <div class="form-group">
                    <label for="form-control-2" class="control-label">Officer Name</label>
                    <input type="text" class="form-control" id="form-control-2" placeholder="Officer Name" data-error="This field is required." required>
                    <div class="help-block with-errors"></div>
                  </div>
                  
                  <div class="form-group">
               <label for="form-control-2" class="control-label"> Officer Password</label>
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="form-control-2" placeholder="Location Name" data-error="This field is required." required>
                    <div class="help-block with-errors"></div>
                  </div>
