...
<%@include file="header.jsp"%>
    ...
    <div class="site-main">
      ...
      <div class="site-content">
        <div class="row">
          <div class="col-sm-6">
            <div class="widget-infoblock wi-large m-b-30" style="background-image: url(adminResourses/images/1.jpg)">
          ...
          <div class="col-sm-6">
            <div class="row">
              <div class="col-sm-6">
                <div class="widget-infoblock wi-small m-b-30" style="background-image: url(adminResourses/images/2.jpg)">
                  <div class="wi-bg"></div>
                  <div class="wi-content-bottom p-a-30">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="widget-infoblock wi-small m-b-30" style="background-image: url(adminResourses/images/3.jpg)">
                  <div class="wi-bg"></div>
                  <div class="wi-content-bottom p-a-30">
              ...
              <div class="table-responsive">
                <table class="table table-borderless">
                  <tbody>
                    <tr>
                      <td>
                        <img class="img-circle" src="adminResourses/images/1.jpg" alt="" width="32" height="32">
                      </td>
                      <td>
                        Jonathan Mel
                        <br>
                    ...
                    <tr>
                      <td>
                        <img class="img-circle" src="adminResourses/images/2.jpg" alt="" width="32" height="32">
                      </td>
                      <td>
                        Landon Graham
                        <br>
                    ...
                    <tr>
                      <td>
                        <img class="img-circle" src="adminResourses/images/3.jpg" alt="" width="32" height="32">
                      </td>
                      <td>
                        Ron Carran
                        <br>
                    ...
                    <tr>
                      <td>
                        <img class="img-circle" src="adminResourses/images/4.jpg" alt="" width="32" height="32">
                      </td>
                      <td>
                        Lucius Skyler
                        <br>
                    ...
                    <tr>
                      <td>
                        <img class="img-circle" src="adminResourses/images/5.jpg" alt="" width="32" height="32">
                      </td>
                      <td>
                        Vance Osborn
                        <br>
                    ...
                    <tr>
                      <td>
                        <img class="img-circle" src="adminResourses/images/6.jpg" alt="" width="32" height="32">
                      </td>
                      <td>
                        Angelica Ramos
                        <br>
                    ...
                    <tr>
                      <td>
                        <img class="img-circle" src="adminResourses/images/7.jpg" alt="" width="32" height="32">
                      </td>
                      <td>
                        Brenden Wagner
                        <br>
    ...
    <script src="adminResourses/js/index.min.js"></script>
  </body>
</html>