            ...
            <ul class="nav navbar-nav">
              <li class="visible-xs-block">
                <div class="nav-avatar">
                  <img class="img-circle" src="adminResourses/images/1.jpg" alt="" width="48" height="48">
                </div>
                    ...
                    <div class="row gutter-xs">
                      <div class="col-xs-4">
                        <div class="a-item">
                          <a href="#">
                            <div class="ai-icon">
                              <img class="img-responsive" src="adminResourses/images/dropbox.png" alt="">
                            </div>
                      ...
                      <div class="col-xs-4">
                        <div class="a-item">
                          <a href="#">
                            <div class="ai-icon">
                              <img class="img-responsive" src="adminResourses/images/github.png" alt="">
                            </div>
                      ...
                      <div class="col-xs-4">
                        <div class="a-item">
                          <a href="#">
                            <div class="ai-icon">
                              <img class="img-responsive" src="adminResourses/images/wordpress.png" alt="">
                            </div>
                      ...
                      <div class="col-xs-4">
                        <div class="a-item">
                          <a href="#">
                            <div class="ai-icon">
                              <img class="img-responsive" src="adminResourses/images/gmail.png" alt="">
                            </div>
                      ...
                      <div class="col-xs-4">
                        <div class="a-item">
                          <a href="#">
                            <div class="ai-icon">
                              <img class="img-responsive" src="adminResourses/images/drive.png" alt="">
                            </div>
                      ...
                      <div class="col-xs-4">
                        <div class="a-item">
                          <a href="#">
                            <div class="ai-icon">
                              <img class="img-responsive" src="adminResourses/images/dribbble.png" alt="">
                            </div>
                ...
                <div class="dropdown-menu custom-dropdown dropdown-notifications dropdown-menu-right">
                  ...
                  <div class="n-items">
                    <div class="custom-scrollbar">
                      <div class="n-item">
                        <div class="ni-img">
                          <img class="img-circle" src="adminResourses/images/1.jpg" alt="" width="40" height="40">
                        </div>
